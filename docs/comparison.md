...
- Spotpy **does not simulate** water; SHRINE **does not ship** a calibration suite (roadmap: tighter reference models and benchmarks in **3.9** / **3.10**).
...
|--------------------|--------|
| **Maturity** | Early OSS; not PyPI-published yet (**3.6**); legacy domain debt |
