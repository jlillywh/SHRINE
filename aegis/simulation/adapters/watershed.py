"""Adapter: legacy :class:`~hydrology.watershed.Watershed` → :class:`~aegis.simulation.protocols.Simulatable`."""
...
from aegis.simulation.flow import FlowSolveResult, NetworkXFlowSolver, SolveMethod
