...
deprecate_colocated_module(path="geometry.test_cylinder", migrated_to="tests/geometry/ (pending)")
...
class TestCylinder(TestCase):
    ...
    def test_volume(self):
        ...
        self.assertAlmostEqual(
            self.cylinder.volume().magnitude, expected_volume.magnitude, places=3
        )
