...
class Root:
    def __init__(self, high_guess=9.0e3, low_guess=1.0e-4, error_tolerance=1.0e-5, max_loops=200):
    ...
    def binary_search(self, function):
        ...
        while not converged:
            ...
            if loop_count > self.max_loops:
                print("Flow solver did not converge after " + str(self.max_loops) + " iterations!")
                break
